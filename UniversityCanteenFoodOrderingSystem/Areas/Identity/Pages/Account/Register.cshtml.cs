    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.UserType = "Customer"; // Default role
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Page(
                        ...
                        pageHandler: null,
                        values: new { area = "Identity", userId = userId, code = encodedToken, returnUrl },
                    ...
                    if (_userManager.Options.SignIn.RequireConfirmedAccount || _userManager.Options.SignIn.RequireConfirmedEmail)
                    {
                        ...
                        // ✅ Pass token to RegisterConfirmation so link shows
                        return RedirectToPage("RegisterConfirmation", new { email = Input.Email, token = encodedToken, returnUrl });
                    }
                    else
                    {
                        await _signInManager.SignInAsync(user, isPersistent: false);
                        TempData["Message"] = "Registration successful! Email verified automatically.";
